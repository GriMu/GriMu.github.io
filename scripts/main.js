...
function(t, e, n) {
    ...
    console.info("%c 🎯 欢迎来到ChengZC同学的博客 ⬇️ ", u),
    console.info("%c 🏷 获得“发现彩蛋”成就 ", u),
    console.info("%c 📅 快去首页联系我吧 ", u),
    console.info("%c 📦 http://www-1256525464.cos-website.ap-chengdu.myqcloud.com", u),
    (0, r.
default)(),
    (0, i.scroll)();
    var h = new s.
...
default = void 0;
    ...
    e.
default = function() {
        document.querySelectorAll(".article-entry img").forEach(r),
        document.querySelectorAll(".about-body container img").forEach(r)
    }
}]);